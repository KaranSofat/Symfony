...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'raa.twig_extension' => 'getRaa_TwigExtensionService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'review-an-airline', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_dea60db741c95d851abe86321bdefd57');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_dea60db741c95d851abe86321bdefd57');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_dea60db741c95d851abe86321bdefd57');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => (dirname(dirname(dirname(__DIR__))).'/src/RAA/WebBundle/Entity'), 1 => (dirname(dirname(dirname(__DIR__))).'/src/RAA/AdminBundle/Entity')));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'RAA\\WebBundle\\Entity');
        $f->addDriver($e, 'RAA\\AdminBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('RAAWebBundle' => 'RAA\\WebBundle\\Entity', 'RAAAdminBundle' => 'RAA\\AdminBundle\\Entity'));
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 123456789);
    }
    ...
    /**
     * Gets the 'raa.twig_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \RAA\WebBundle\Extension\TwigExtension A RAA\WebBundle\Extension\TwigExtension instance.
     */
    protected function getRaa_TwigExtensionService()
    {
        return $this->services['raa.twig_extension'] = new \RAA\WebBundle\Extension\TwigExtension();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('raa.twig_extension'));
        ...
        $instance->addGlobal('fbAppId', '863291650356318');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/RAA/WebBundle/Resources/views'), 'RAAWeb');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/RAA/AdminBundle/Resources/views'), 'RAAAdmin');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'RAAWebBundle' => 'RAA\\WebBundle\\RAAWebBundle',
                'RAAAdminBundle' => 'RAA\\AdminBundle\\RAAAdminBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'review-an-airline',
            'database_user' => 'root',
            'database_password' => 'root',
            'mailer_transport' => 'smtp',
            'mailer_encryption' => NULL,
            'mailer_auth_mode' => 'login',
            'mailer_host' => 'mail.reviewanairline.com',
            'mailer_port' => 25,
            'mailer_user' => 'info@reviewanairline.com',
            'mailer_password' => 'info@123',
            'locale' => 'en',
            'secret' => 123456789,
            'facebook.app_id' => '863291650356318',
            'facebook.secret' => '6b05f5cc69c430d62ed8b41e528fde95',
            'web_url' => 'http://reviewanairline.com/web/success',
            'reg_url' => 'http://reviewanairline.com/web/registered',
            'website_url' => 'http://localhost/review-an-airline/',
            'gbl_root_dir' => '/review-an-airline/',
            'gbl_email_support' => 'support@reviewanairline.com',
            'gbl_email_service' => 'service@reviewanairline.com',
            'gbl_email_administrator' => 'administrator@reviewanairline.com',
            'current_url' => 'http://review-an-airline/web/profile/',
            'raa.twig_extension.class' => 'RAA\\WebBundle\\Extension\\TwigExtension',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'mail.reviewanairline.com',
            'swiftmailer.mailer.default.transport.smtp.username' => 'info@reviewanairline.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'info@123',
